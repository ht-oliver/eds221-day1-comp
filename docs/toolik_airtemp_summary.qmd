...
## Beginning of example 2. Create a plot of chlorphyll concentration at varying measruement depth, do some customization.

```{r}
# Tell R where to read data from
...
# One of the columns is populated with ".", this line says "If data in sucha column is ".", replace it with NA
na_if(toolik_chlorophyll$active_chl_a_ug_l, "." )

#Convert chlorophyll data to numeric
